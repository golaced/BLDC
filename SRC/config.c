...
void checkFirstTime(bool eepromReset)
{
    ...
    if (eepromReset || test_val != checkNewEEPROMConf)
    {
        ...
        // Luke Liu eepromConfig.PID[ROLL_PID].P               =   10.0f;
        eepromConfig.PID[ROLL_PID].P               =   3.0f;
        ...
        eepromConfig.PID[YAW_PID].P                =   3.0f;
        // Luke Liu eepromConfig.PID[YAW_PID].P                =   10.0f;
        ...
        //Luke Liu eepromConfig.rollEnabled  = false;
